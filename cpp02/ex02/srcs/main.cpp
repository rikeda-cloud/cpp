...
// 	std::cout << f1.toFloat() << cmp << f2.toFloat() << " = " << result << std::endl;
// }
// 
...
// 	Fixed	fixed1(float1);
// 	std::cout << "[base = " << fixed1.toFloat() << "; ++() ()++ --() ()--" << "]" << std::endl;
// 	std::cout << "++ " << (++fixed1).toFloat() << std::endl;
// 	Fixed	fixed2(float1);
// 	std::cout << (fixed2++).toFloat() << " ++" << std::endl;
// 	Fixed	fixed3(float1);
// 	std::cout << "-- " << (--fixed3).toFloat() << std::endl;
// 	Fixed	fixed4(float1);
// 	std::cout << (fixed4--).toFloat() << " --" << std::endl;
// }
// 
